...
"""
        ...
        if not crash_detected:            
            ...
            if submission_result or True: # for local test w/o submission endpoint
                ...
                # Save to main patch folder
                # project_dir is patch_workspace, we need to go up to get the original workspace
                # e.g., /root/.../workspace/libpng_20251215_175412/patch_workspace
                # -> /root/.../workspace/libpng_20251215_175412
                original_workspace = os.path.dirname(project_dir.rstrip('/'))
